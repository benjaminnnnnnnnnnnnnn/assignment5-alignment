...
class TrainConfigDebug:
    ...
    experiment_name: str = "GRPO-qwen2.5-gsm8k_clip_debug"
...
class TrainConfig:
    experiment_name_base: str = "experiments"
    experiment_name: str = "GRPO-qwen2.5-gsm8k-grpoClip-baseline"
    model_name: str = "Qwen/Qwen2.5-Math-1.5B"
    data_path: str = "./data/gsm8k/train.jsonl"
...
def evaluate_sft_model(config: EvaluateConfig, vllm: LLM, eval_step: int):
    ...
    results = evaluate_vllm(vllm, question_only_reward_fn, prompts, answers, sp)
